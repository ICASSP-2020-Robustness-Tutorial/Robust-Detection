...
Q, I_val, c, nit = mlfds.density_band_proximal(f, df, P_min, P_max, dx, verbose=True)
...
Q, I_val, c, nit = mlfds.outliers(f, df, P, dx, 0.1, verbose=True)
...
Q, I_val, c, nit = mlfds.outliers_proximal(f, df, P, dx, 0.1, verbose=True)
