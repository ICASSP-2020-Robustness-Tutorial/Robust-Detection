function [Q, I, residuals, c, nit] = multi_lfds_outlier(f, df, f_param, P, dw, eps, varargin)
...
while true
    ...
    [Q, I, residuals, c, nit] = multi_lfds_density_band(f, df, f_param, P_min, P_max, dw, varargin);
